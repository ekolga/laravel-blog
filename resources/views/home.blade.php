        ...
        <div class="left-side-block">
            <div class="left-side-block__user-profile">
                <div class="left-side-block__user-photo">
                    <img id="left-side-block__profile-logo" src="images/profile-picture.jpg" alt="profile-logo">
                </div>
        ...
        <div class="body-content">
            <div class="article">
                <div class="article__title">
                    <a href="index.html"><h1>Test article</h1></a>
                </div>
            ...
            <div class="article">
                <div class="article__title">
                    <a href="index.html"><h1>Another test article</h1></a>
                </div>
                <div class="article__post-date">
            ...
            <div class="article">
                <div class="article__title">
                    <a href="index.html"><h1>Another one article for testing purposes</h1></a>
                </div>
                <div class="article__post-date">
